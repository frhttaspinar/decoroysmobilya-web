      ...
      <div className="max-w-4xl mx-auto px-6 py-16 md:py-24">
        ...
        <div className="prose prose-zinc prose-a:text-blue-600 hover:prose-a:text-blue-700 max-w-none text-zinc-600 font-light leading-relaxed">
          <p>
            ...
            Kullanmakta olduğunuz www.decoroys.com web sitesi üzerinden elektronik ortamda sipariş verdiğiniz takdirde, size sunulan ön bilgilendirme formunu ve mesafeli satış sözleşmesini kabul etmiş sayılırsınız.
            ...
            Satın alınan her bir ürün, 30 günlük yasal süreyi aşmamak kaydı ile  alıcının gösterdiği adresteki kişi ve/veya kuruluşa teslim edilir. Bu süre içinde ürün teslim edilmez ise,  Alıcılar sözleşmeyi sona erdirebilir. Satın alınan ürün, eksiksiz ve siparişte belirtilen niteliklere uygun teslim edilmek zorundadır.
            ...
            ALICI; satın aldığı ürünün kendisine veya gösterdiği adresteki kişi/kuruluşa teslim tarihinden itibaren 14 (on dört) gün içerisinde, SATICI’ya aşağıdaki iletişim bilgileri üzerinden bildirmek şartıyla. Ürün ambalajını, jelatinini açmadan ve kullanmadan hiçbir hukuki ve cezai sorumluluk üstlenmeksizin ve hiçbir gerekçe göstermeksizin malı reddederek sözleşmeden cayma hakkını kullanabilir. (Jelatini, Ambalajı ve Kutusu açılmış tahrip olmuş ürünlerin iadesi yapılamaz)
